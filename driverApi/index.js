...
var getShows = exports.getShows = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getShows.ss', params, callback);
};
//广告商品
var getAdProducts = exports.getAdProducts = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getAdProducts.ss', params, callback);
};
//版本查询接口
var getAppVersion = exports.getAppVersion = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getAppVersion.ss', params, callback);
};
//我的收藏-查询我收藏的品牌
var getFavorBrandList = exports.getFavorBrandList = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getFavorBrandList.ss', params, callback);
};
//商品详细-商品图文详情获得接口
var getDetial = exports.getDetial = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getDetial.ss', params, callback);
};
//商品详细-商品SKU信息获得接口
var getSkuInfo = exports.getSkuInfo = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getSkuInfo.ss', params, callback);
};
//热门关键字接口
var getKeywordList = exports.getKeywordList = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/getKeywordList.ss', params, callback);
};
//用户预注册接口【隐私】【HTTPS】
var preReg = exports.preReg = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/preReg.ss', params, callback);
};
//用户完成注册接口【隐私】【HTTPS】
var doneReg = exports.doneReg = function(params, callback){
    Driver.queryByPost('http://meizhuangyouxuan.com/app/inter/doneReg.ss', params, callback);
};